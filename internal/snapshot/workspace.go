...
func writeFileFromChunks(ctx context.Context, st *store.StoreSet, path string, chunks []core.Hash, perm os.FileMode) (err error) {
...
// restored entries.
func RestoreFilesToWorkspace(ctx context.Context, st *store.StoreSet, workDir, ignoreFile string, snap *core.Snapshot) error {
...
func RebuildIndexFromSnapshot(ctx context.Context, st *store.StoreSet, snapID core.SnapshotID) error {
