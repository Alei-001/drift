...
// CompactChunks implements store.ChunkCompactor for the filesystem backend.
func (fs *FSStorage) CompactChunks(ctx context.Context, reachable map[core.Hash]bool, dryRun bool) (store.CompactReport, error) {
	var report store.CompactReport
